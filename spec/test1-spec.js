...
describe('checkStringForPattern', function() {
    var checkStringForPattern = pattern_and_string.checkStringForPattern;

    it("should return false if the length of the pattern doesn't match " +
        "the number of space separated substrings",
        function() {
            var pattern = [1];
            var string = "cat dog dog cat";
            var result = checkStringForPattern(pattern, string);
    ...
    it("should return false if the pattern doesn't match the string",
        function() {
            var pattern = [1, 2, 2, 1];
